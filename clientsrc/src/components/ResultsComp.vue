...
<div class="progress bg-info">
  <div class="progress-bar" role="progressbar" :style="resultsBar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
  </div>
</div>
...
export default {
  ...
  methods:{
    calculatePercent() {
      this.supportValue = this.postData.support.length;
      this.disregardValue = this.postData.disregard.length;
      this.sumValue = this.supportValue + this.disregardValue;
      this.resultsBar = 'width:' + ((this.supportValue/this.sumValue) *100) +'%'
